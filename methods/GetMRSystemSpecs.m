...
% (c) 2026 Skope Magnetic Resonance Technologies AG  
    ...
    switch scannerType
        ...
        case 'Siemens 3T Cima.X'
            ...
            specs.maxSlew = 200; 
            specs.B0 = 2.89;            
            specs.forbiddenBandsEchoSpacingLimits = [0.68e-3, 0.87e-3;... %[1113,344]Hz
        ...
        case 'Siemens 3T Connectom'
            ...
            specs.maxSlew = 200; 
            specs.B0 = 2.89;            
            specs.forbiddenBandsEchoSpacingLimits = [0.8e-3, 0.57e-3;... %[1250,500]Hz
                                                     1.68e-3, 1.44e-3 ]; %[596,100] Hz
        % 7T 
