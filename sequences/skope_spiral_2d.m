...
% (c) 2024 Skope Magnetic Resonance Technologies AG
    ...
    methods
        ...
        function obj = skope_spiral_2d(seqParams, waveform)
            ...
            nSamplesADC = floor(durADC/obj.adcDwelltime);
            ...
            obj.gxRefoc = mr.makeTrapezoid('x','Area',mx,'system', obj.sys);
            obj.gyRefoc = mr.makeTrapezoid('y','Area',my,'system', obj.sys);            
            refocTime = max([mr.calcDuration(obj.gzSpoil),mr.calcDuration(obj.gxRefoc),mr.calcDuration(obj.gyRefoc)]);

            % Stretch gradients
            obj.gzSpoil = mr.makeTrapezoid('z','Area',4/obj.thickness,'system', obj.sys, 'Duration',refocTime);
            obj.gxRefoc = mr.makeTrapezoid('x','Area',mx,'system', obj.sys, 'Duration',refocTime);
            obj.gyRefoc = mr.makeTrapezoid('y','Area',my,'system', obj.sys, 'Duration',refocTime);
            ...
            obj.seq.write('exports/skope_spiral_2d.seq')
    ...
    methods (Access=private) 
        ...
        function obj = runKernel(obj, lin, slc, avg, doPlayRF)
            ...
            obj.gx = mr.makeArbitraryGrad('x',gx,'Delay',mr.calcDuration(obj.gzReph));
            obj.gy = mr.makeArbitraryGrad('y',gy,'Delay',mr.calcDuration(obj.gzReph));

            obj.seq.addBlock(obj.gx, obj.gy, obj.adc, mr.makeLabel('SET','ECO', 0), labels{:});
        
            %% Spoiling
            [gxRefoc, gyRefoc] = mr.rotate('z',phi,{obj.gxRefoc, obj.gyRefoc});
